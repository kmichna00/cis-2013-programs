...
var passwordCheckOld = function () 
{
  ...
  if (intCount < 8)
  {
   stringOutput = "The password entered is not enough characters.";
  }
  else
  {
   for (i = 0; i < arrayBadPasswords.length; i++)
   {
      ...
      {
         stringOutput = "The password entered is inappropriate. Try a new password.";
         break;
      }
   }
  }
  ...
  if (stringOutput != "The password entered is not enough characters." && stringOutput != "The password entered is inappropriate. Try a new password.")
  {
   stringOutput = "The password entered is good.";
  }
